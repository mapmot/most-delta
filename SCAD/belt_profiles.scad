...
GT2 = [
	...
	0.75, // ht, tooth height (mm) -- 2
	2, // s, tooth root width (mm) -- 3
	100, // g, tooth flank angle (deg) -- 4
	0.555, // ra, tip radius connecting tooth flank to tooth tip (mm) -- 5
	1, // rr, root radius connecting tooth flank to belt root line (mm) -- 6
	1.3, // w_scale, factor applied to scale tooth width -- 7
	1.3 // h_scale, factor applied to scale tooth height -- 8
];
